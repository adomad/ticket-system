...
class AdminController extends Controller
{
    ...
    public function edit_category(Request $request, $id)
    {
        ...
        toast("updated sucessefully", "success");
    ...
    public function create_subcategory(Request $request)
    {
        ...
        toast("Created sucessefully", "success");
    ...
    public function delete_subcategory($id)
    {
        ...
        if ($subcategory->bookings->count()) {
            toast('SubCategory has bookings. Cant be deleted', 'error');
            return back();
        }
    ...
    public function delete_category($id)
    {
        ...
        if ($categroy->subCategories->count()) {
            toast('Category has subcategories. Please delete subcategories first', 'error');
            return back();
        }

        if ($categroy->bookings->count()) {
            toast('Category has bookings. Cant be deleted', 'error');
            return back();
        }
