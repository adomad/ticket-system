...
<div class="container">
  <form id="category-form" method="POST" action="{{ route('create_subcategory') }}" style="margin-left:120px; margin-top:20px;">
    ...
    {{-- <div class="form-group">
      ...
      <input type="number" step="0.01"  class="form-control" id="tax" name="tax" placeholder="Enter Total Tax">
    </div> --}}
    <div class="form-group">
      <label for="message">Pawanmedia  :</label>
      <input type="number" step="0.01"  class="form-control" id="pawanmedia" name="pawanmedia" placeholder="Enter Total Pawan media revenue">
    </div>
    <div class="form-group">
      <label for="message">Nagarpalika Tax:</label>
      <input type="number" step="0.01"  class="form-control" id="taxngarpalika" name="taxngarpalika" placeholder="Enter nagarpalika Tax">
    </div>
    <div class="form-group">
      <label for="message">Park :</label>
      <input type="number" step="0.01"  class="form-control" id="park" name="park" placeholder="Enter Park Revenue">
    </div>
    <div class="form-group">
      <div class="form-group">
