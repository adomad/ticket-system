...
<div class="container">
    <form id="subcategory-form" style="margin-left:100px; margin-top:20px;" method="POST" action="{{ route('edit_subcategory', ['id' => $id]) }}">
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01"  class="form-control" id="price" name="price" placeholder="Enter price" value="{{ old('price', $subcategory->price) }}">
        ...
        {{-- <div class="form-group">
            ...
            <input type="number" step="0.01"  class="form-control" id="tax" name="tax" placeholder="Enter Total Tax" value="{{ old('tax', $subcategory->tax) }}">
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01"  class="form-control" id="pawanmedia" name="pawanmedia" placeholder="Enter Total Pawan media revenue" value="{{ old('pawanmedia', $subcategory->pawanmedia) }}">
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01"  class="form-control" id="taxngarpalika" name="taxngarpalika" placeholder="Enter nagarpalika Tax" value="{{ old('taxngarpalika', $subcategory->taxngarpalika) }}">
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01"  class="form-control" id="park" name="park" placeholder="Enter Total Park Revenue" value="{{ old('park', $subcategory->park) }}">
